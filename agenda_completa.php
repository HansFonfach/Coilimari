...
<br>
  ...
  <?php
   ...
   $sql="SELECT clientes.Rut, Asistencia, Comentario, clientes.Nombre, clientes.Apellido, clientes.Telefono, doctores.Nombre AS Doctores, servicios.Nombre AS Servicio, horarios.Horas, reservas.Fecha
FROM clientes
            ...
            <div class="card-body">
              ...
              ?>  
                    ...
                    <td  class="mostrar"><?php if(isset($datos['Fecha'])){echo $datos['Fecha'];} ?></td>
                     <td  class="mostrar"><?php if(isset($datos['Comentario'])){echo $datos['Comentario'];} ?>
