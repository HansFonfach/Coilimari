...
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 container">
      ...
      <div class="card shadow mb-3" >
        <h2 class="card-header bg-primary text-white text-center ">Bienvenido:  <?php  echo $texto = strtoupper($_SESSION['usuario_sesion']); ?> </h2>
         
        <div class="card-body">
          <div class="list-group">
            <a href="reserva_cliente.php" class="list-group-item list-group-item-action  text-center"> Reservar Hora </a>
            <a href="cancelar_hora.php" class="list-group-item list-group-item-action text-center">Cancelar Hora</a>
            <a href="agenda_cliente.php" class="list-group-item list-group-item-action text-center">Horas Agendadas </a>
            <a href="modificar_datos.php" class="list-group-item list-group-item-action text-center">Editar Datos</a>
