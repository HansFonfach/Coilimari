  ...
  <html>
  <head>
    <tittle>COI - Centro Odontológico Integral</tittle>
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <link rel="stylesheet" href="//code.jquery.com/ui/1.10.1/themes/base/jquery-ui.css" />
      <script src="//code.jquery.com/jquery-1.9.1.js"></script>
      <script src="//code.jquery.com/ui/1.10.1/jquery-ui.js"></script>
      <script src="js/form_reserva_usu2.js" type="text/javascript"></script>
    <!--JQUERY-->
...
<br>
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 container">
      <div class="card shadow mb-3">
        ...
        <div class="card-body">
          ...
          <form id="form" name="form"  method="post" action="procesa_reserva_admin.php">
            Fecha
        ...
        <div class="form-group">
              Rut Paciente
              <input class="form-control " id="Rut" maxlength="10" required="" name="Rut"type="text"  placeholder="Ingrese rut" autocomplete="off" onBlur="comprobarUsuario()">
 ...
 <button type="button" onclick="location.href='ambiente_admin.php';" class="btn btn-space btn-danger ">Cancelar</button>
            </p>
          </div>
        </div>
      </form>
        ...
        <div class="col-lg-4">
          <div class="footer-widget">
            <div class="fw-about">
              ...
              <div class="fw-social">
                <a href=""><img src="img/124010.png"width="50" height="50"></a>
