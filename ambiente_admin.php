...
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 container">
      ...
      <div class="card shadow mb-3">
                                <h2 class="card-header text-center  bg-primary text-white " >Administrador</h2>
                             
                                <div class="card-body">
                                    <div class="list-group" >
                                        <a href="reserva_admin.php" class="list-group-item list-group-item-action  text-center">Reservar Pacientes </a>
                                       
                                        <a href="pacientes.php" class="list-group-item list-group-item-action text-center">Pacientes Registrados</a>
                                        <a href="agenda_completa.php" class="list-group-item list-group-item-action text-center">Agenda Completa</a>
                                         <a href="agenda_hoy.php" class="list-group-item list-group-item-action text-center">Agenda Diaria</a>
