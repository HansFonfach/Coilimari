            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" id="form"action="ingreso_procesa.php" method="post" >
                    <div class="form-group">
                      <input type="text" Required="" Name="Rut" maxlength="11" oninput="checkRut(this)" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingrese su rut...">
                    </div>
                    <div class="form-group">
