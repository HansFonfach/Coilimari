...
<br>
  ...
  <?php
   ...
   $sql="SELECT clientes.Rut, clientes.Nombre, clientes.Apellido, clientes.Telefono, doctores.Nombre AS Doctores, servicios.Nombre AS Servicio, horarios.Horas, reservas.Fecha
FROM clientes
...
WHERE clientes.Rut ='".$_SESSION['Rut']."' ORDER BY Fecha DESC";
